...
const ProductList: Component<ProductListTemplateProps> = ( props ) =>
{
    ...
    return (
        <section class="section_container">
            ...
            <header class="section_header_container" data-parent={permissions.PRODUCTS.SAVE}>
                ...
                <div class="has-permission">
                    <Link href={'/products/create'}>
                        <Button leftIcon={<Icon ><IconPlus/></Icon>}><Text message="p_create"/></Button>
                    </Link>
                </div>
            </header>
            ...
            <div class="grid_cards_container">
                <Show when={!props.loading || props.productList?.length}>
                    <For each={props.productList} fallback={<div><Text message="p_no_products" /></div>}>
                        {( product ) =>
